...
// Adapted from RiftLanceEffect, but removes the mines and changes the darkening to a frost effect
// TODO UNUSED! Still has a darkening effect, use ArcticFrostRayEffect instead
public class FrostLanceEffect implements BeamEffectPlugin { //WithReset {
...
//	}
	...
	public void advance(float amount, CombatEngineAPI engine, BeamAPI beam) {
		...
		//if (beam.getDamageTarget() != null) {
			done = false; // Used to be true, might cause infinite loop
