...
// The exact same as CryoblasterEffect in vanilla, except it doesn't require the projectile to be of type 'projectile'
public class ArcticCryoblasterEffect extends BaseCombatLayeredRenderingPlugin implements OnFireEffectPlugin,
																				   OnHitEffectPlugin {

	public ArcticCryoblasterEffect() {
	}

	public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, ApplyDamageResultAPI damageResult, CombatEngineAPI engine) {
		// This used to be projectile.getProjectileSpec().getFringeColor()
	...
	public void onFire(DamagingProjectileAPI projectile, WeaponAPI weapon, CombatEngineAPI engine) {
		ArcticCryoblasterEffect trail = new ArcticCryoblasterEffect(projectile);
...
//			}
	...
	public ArcticCryoblasterEffect(DamagingProjectileAPI proj) {
		this.proj = proj;
...
//		float y = entity.getLocation().y;
		...
		// Edited here to hard code a color instead of getting the projectile's fringe color
		// This used to be projectile.getProjectileSpec().getFringeColor()
		Color color = new Color(100,150,255);
